...
export interface ApiAboutCoderzAboutCoderz extends Struct.SingleTypeSchema {
  collectionName: 'about_coderzs';
  info: {
    displayName: 'About Coderz';
    pluralName: 'about-coderzs';
    singularName: 'about-coderz';
  };
  options: {
...
export interface ApiAwardsAndRecognitionAwardsAndRecognition
  extends Struct.SingleTypeSchema {
  collectionName: 'awards_and_recognitions';
  info: {
    displayName: 'Awards and Recognition';
    pluralName: 'awards-and-recognitions';
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::awards-and-recognition.awards-and-recognition'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiCoderzPortfolioCoderzPortfolio
  extends Struct.SingleTypeSchema {
  collectionName: 'coderz_portfolios';
  info: {
    displayName: 'Coderz Portfolio';
    pluralName: 'coderz-portfolios';
    singularName: 'coderz-portfolio';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::coderz-portfolio.coderz-portfolio'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPortfolioPortfolio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    InfoCard: Schema.Attribute.Component<'information-card.info-card', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    project_intro: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    seo_tags: Schema.Attribute.Component<'seo.seo', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::about-coderz.about-coderz': ApiAboutCoderzAboutCoderz;
